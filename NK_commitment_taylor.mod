...
%            adjust the interest rate to reduce losses using the Taylor rule
...
parameters betta sig tetap kapa phin alpha epsi rhoa rhog rhov rhos phi1 phi2 phi3 omega; 
...
ramsey_policy(instruments=(i),irf=13,planner_discount=betta) x pi i v s;
